    ...
    <>
      ...
      {!isOpen && (
        <button
          ...
          className="fixed bottom-6 right-6 bg-gradient-to-r from-purple-600 to-green-600 text-white rounded-full p-4 shadow-2xl hover:shadow-3xl transition-all duration-200 transform hover:scale-110 z-[9999] animate-bounce"
