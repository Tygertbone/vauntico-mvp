      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative max-w-xl">
            <div className="absolute inset-y-0 left-3 top-1/2">
              <Search className="w-5 h-5 text-gray-400 absolute top-1/2" />
              <input
                type="text"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <div className="text-green-600 text-sm">Free</div>
                </div>
                <div className="text-right">
                  <div className="text-purple-600 text-lg font-bold">{kit.price === 0 ? 'FREE' : `$${kit.price}`}</div>
          ...
          <div className="mt-4 pt-4 border-t border-gray-600">
            <button className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 font-semibold hover:from-purple-700 to-pink-800 transition-all">
        ...
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-3xl p-12 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-6">
            ...
            <div className="flex justify-center space-x-4">
              <Link to="/creator-pass" className="bg-white text-purple-600 px-8 py-4 rounded-lg font-semibold hover:from-purple-700 hover:to-pink-800 transition-all">
                Get Started Free
              </Link>
              <Link to="/pricing" className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white/10 hover:to-gray-200 transition-all">
                View All Kits
              </Link>
            </div>
          </div>
