  ...
  ((a.id = 44),
    ...
    (a.modules = {
          ...
          constructor(a) {
            (super(),
              (this.headers = new Proxy(a, {
                get(b, c, e) {
                  if ("symbol" == typeof c)
                    return d.ReflectAdapter.get(b, c, e);
                  let f = c.toLowerCase(),
      ...
      8860: (a, b, c) => {
        "use strict";
        (c.r(b),
          c.d(b, { config: () => l, default: () => k, handler: () => n }));
        var d = c(9046),
          e = c(8667),
          f = c(3480),
          g = c(6435),
          ...
          i = c(8112),
          j = c(8766);
        let k = (0, g.M)(h, "default"),
          l = (0, g.M)(h, "config"),
          m = new f.PagesAPIRouteModule({
            definition: {
              kind: e.A.PAGES_API,
              page: "/api/sync-scroll",
              pathname: "/api/sync-scroll",
              bundlePath: "",
              filename: "",
            },
            userland: h,
        ...
        async function n(a, b, c) {
          let e = await m.prepare(a, b, { srcPage: "/api/sync-scroll" });
          if (!e) {
            ((b.statusCode = 400),
              b.end("Bad Request"),
          ...
          try {
            let c = a.method || "GET",
              ...
              l = m.instrumentationOnRequestError.bind(m),
              n = async (e) =>
                m
                  .render(a, b, {
                    query: { ...f, ...g },
                    ...
                    dev: m.isDev,
                    page: "/api/sync-scroll",
                    internalRevalidate: null == k ? void 0 : k.revalidate,
                    onError: (...b) => l(a, ...b),
                  })
                  .finally(() => {
                    if (!e) return;
                    ...
                    if (!f) return;
                    if (
                      f.get("next.span_type") !== j.BaseServerSpan.handleRequest
                    )
            ...
            if (m.isDev) throw a;
            (0, d.sendError)(b, 500, "Internal Server Error");
          } finally {
            null == c.waitUntil || c.waitUntil.call(c, Promise.resolve());
          }
        }
