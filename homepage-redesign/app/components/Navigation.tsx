...
export function Navigation({ variant, onVariantChange }: NavigationProps) {
  ...
  return (
    <>
      ...
      {/* Navigation Bar */}
      <nav className="fixed top-0 w-full bg-background-primary/80 backdrop-blur-lg border-b border-border-default z-50" role="navigation" aria-label="Main navigation">
